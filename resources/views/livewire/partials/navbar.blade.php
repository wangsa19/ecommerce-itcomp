        ...
        <div class="relative md:flex md:items-center md:justify-between">
            <div class="flex items-center justify-between">
                <a class="flex-none text-xl font-semibold dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    ...
                    <img src="{{ asset('assets/images/logo/logodark1.png') }}" alt="Logo ITComp" width="100">
                </a>
                <div class="md:hidden">
                    <button type="button"
            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a wire:navigate
                            class="font-medium flex items-center {{ request()->is('cart') ? 'text-blue-500' : 'text-gray-500' }} hover:text-gray-400 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/cart">
                        ...
                        @auth
                            ...
                            <div x-data="{ open: false }" @mouseenter="open=true" @mouseleave="open=false" class="md:py-4">
                                ...
                                <div x-show="open" x-transition
                                    class="absolute right-0 z-10 mt-5 w-48 bg-white md:shadow-md rounded-lg p-2 dark:bg-gray-800 border dark:border-gray-700">
